...
const hotelSchema = new mongoose.Schema({ //first line tells us create a new schema store that in hotelSchema
...
const Hotel = mongoose.model("Hotel", hotelSchema);//this is making a model in the mongoDB
//storing it in Hotel
module.exports = Hotel;//exporting the data from this file especially 